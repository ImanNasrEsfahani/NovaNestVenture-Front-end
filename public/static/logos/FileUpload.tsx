...
const FileUpload = ({ name, label, onChange }: FileUploadProps) => {
  return (
    <div className="flex flex-col items-center gap-2">
      <div>
        <p className="text-grayLabel font-medium text-xs md:text-lg 2xl:text-2xl">
          {label}
        </p>
      </div>
      <div className="w-full md:w-1/2 bg-whiteGold drop-shadow-md flex justify-center relative overflow-hidden">
