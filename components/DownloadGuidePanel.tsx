...
export default function DownloadGuidePanel({
  ...
  description = 'Get detailed information about the Canada Startup Visa program, including step-by-step application process, success stories, and expert tips to maximize your chances of approval.',
  bullets = [
    'Complete program overview and timeline',
  ...
  return (
    <section className={`w-full max-w-responsive mx-auto mb-20 ${className}`}>
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl shadow-2xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500 rounded-full opacity-20 blur-3xl transform translate-x-32 -translate-y-32" />
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-blue-400 rounded-full opacity-20 blur-3xl transform -translate-x-24 translate-y-24" />

        <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center p-8 md:p-12">
          <div className="text-white">
            <div className="inline-flex items-center gap-2 bg-blue-500/30 backdrop-blur-sm rounded-full px-4 py-2 mb-4 text-white">
            ...
            <p className="text-blue-100 text-base leading-relaxed mb-6">{description}</p>
            ...
            <ul className="space-y-3 pl-4 mb-8">
              {bullets.map((b, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-blue-50 text-base">{b}</span>
                </li>
              ))}
            </ul>
            ...
            <a
              ...
              className="pl-4 inline-flex items-center gap-2 bg-white text-blue-700 hover:bg-blue-50 shadow-lg hover:shadow-xl transition-all duration-300 rounded-lg px-6 py-4 mb-2"
              aria-label={buttonLabel}
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-blue-700" aria-hidden="true">
                <path d="M12 15V3" />
          ...
          <div className="h-full relative hidden lg:flex items-center justify-center">
            <div className="h-full w-auto absolute inset-0 bg-blue-400 rounded-2xl transform rotate-6 opacity-20" />
