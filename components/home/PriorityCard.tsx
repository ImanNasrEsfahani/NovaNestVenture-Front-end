  ...
  return (
    <div className="w-full h-36 px-4 pb-6 relative flex items-end justify-center overflow-hidden border border-primary rounded-lg">
      <Image
        ...
        width={500}
        height={500}
        className="text-darkGold bg-darkGold absolute bottom-2 -right-2 max-w-28 max-h-28 opacity-10 md:bottom-0"
      />
      ...
      <Image
        ...
        width={500}
        height={500}
        className="text-darkGold absolute left-2 top-2 max-w-16 max-h-16 lg:max-w-12 lg:max-h-12 z-10"
      />
    </div>
  );
}
