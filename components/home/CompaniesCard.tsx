  ...
  return (
    <Link href={link} target="_blank">
      <div className=" relative flex h-[160px] w-[150px] mb-5 md:mb-0 flex-col items-center group justify-center bg-[#F7F3EE] md:size-[322px] rounded-xl">
        ...
        <span className={`absolute flex items-center justify-center bottom-0 transition-all w-full bg-[#00000069] h-8 md:h-12 ${headingFont} text-sm text-white md:text-lg rounded-md group-hover:h-full`}>
          {name}
        </span>
      </div>
    </Link>
