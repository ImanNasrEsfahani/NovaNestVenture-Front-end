...
const StartUpSaleDevelopRefactore = (props: Props) => {
  ...
  return (
    <div className='w-full h-auto px-4 my-4'>
      ...
      <PitchdeckUpload
        title={t('startUp',{ returnObjects: true }).SaleDevelopment.pitchDeck}
        yesLabel={t('yes')}
        noLabel={t('no')}
        chooseFileLabel={t('startUp',{ returnObjects: true }).SaleDevelopment.choseFile}
        uploadDocumentLabel={t('startUp',{ returnObjects: true }).SaleDevelopment.uploadDocument}
        productNameLabel={t('startUp',{ returnObjects: true }).SaleDevelopment.productName}
        ...
        siteAddressLabel={t('startUp',{ returnObjects: true }).SaleDevelopment.siteAddress}
