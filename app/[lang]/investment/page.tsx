...
export default function Page({
  ...
  return (
    <div dir={lang === 'en' ? 'ltr' : 'rtl'} className="mb-20">
      ...
      <div className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl mx-auto flex justify-between my-28 gap-5 font-header">
      ...
      <div className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-4xl mx-auto py-10 font-header">
